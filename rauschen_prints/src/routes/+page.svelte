	...
	<div class="a2-page" class:page-break={pageIndex > 0}>
		...
		<div class="image-container">
			<div class="image-wrapper">
				<div class="image-with-label">
					<img src="/prints/{pair[0]}" alt="screenshot {pair[0]}" class="screenshot-image" />
					<div class="filename-label">
						{getDisplayName(pair[0])}
					</div>
					<div class="author-label">Lucca Vitters</div>
				</div>
			</div>
		</div>
		...
		{#if pair[1]}
			<div class="image-container">
				<div class="image-wrapper">
					<div class="image-with-label">
						<img src="/prints/{pair[1]}" alt="screenshot {pair[1]}" class="screenshot-image" />
						<div class="filename-label">
